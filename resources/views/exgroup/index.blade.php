    ...
    <div class="container-fluid text-center d.flex justify-content-center px-3 row">
        ...
        @if ($groups->first() != null)
            <div class="col-xl-5 col-lg-5 mb-5">
                ...
                <div class="row px-0 d-flex justify-content-center mb-4">
                    <a href="{{ route('source.report', $source->slug) }}" title="Relatórios">
                    ...
                    <div class="page-header col-lg-2 d-flex justify-content-center align-items-center dropdown">
